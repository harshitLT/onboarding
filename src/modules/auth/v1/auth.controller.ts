import { Controller, Headers, Body, HttpException, HttpStatus, Post, HttpCode, UseGuards, Req } from '@nestjs/common';
...
export class AuthController{
	...
	@HttpCode(200)
	@Post('refresh')
	async refresh( @Headers() headers: RefreshHeadersDTO, @Body() body: RefreshDTO 
	){
		try{
